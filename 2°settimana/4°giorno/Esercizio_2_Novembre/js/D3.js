...
var femaleCharacters = [{ name: "", hair_color: "", eye_color: "" }];
let j = 0;
...
*/
var eyeColor = { blue: [], yellow: [], brown: [], red: [], "blue-gray": [] };
...
var newArray = [];
for (i = 0; i < starWarsCharacters.length; i++) {
  newArray.push(starWarsCharacters[i]);
}
...
console.log('il nome del personaggio è :' + starWarsCharacters[index].name);
console.log('l altezza del personaggio è :' + starWarsCharacters[index].height);
console.log('il colore dei capelli del personaggio è :' + starWarsCharacters[index].hair_color);
console.log('il colore della pelle del personaggio è :' + starWarsCharacters[index].skin_color);
console.log('il colore degli occhi del personaggio è :' + starWarsCharacters[index].eye_color);
console.log('lanno di nascita del personaggio è :' + starWarsCharacters[index].birth_year);
console.log('il sesso del personaggio è :' + starWarsCharacters[index].gender);
